...
function(wolf_find_boost)
    ...
    if(WIN64)
		if (CMAKE_BUILD_TYPE MATCHES Debug)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_atomic-vc142-mt-gd-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_context-vc142-mt-gd-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_fiber-vc142-mt-gd-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_date_time-vc142-mt-gd-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_regex-vc142-mt-gd-x64-1_75.lib)
		else()
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_atomic-vc142-mt-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_context-vc142-mt-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_fiber-vc142-mt-s-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_date_time-vc142-mt-s-x64-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_regex-vc142-mt-s-x64-1_75.lib)
		endif()
    elseif(WIN32)
		if (CMAKE_BUILD_TYPE MATCHES Debug)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_atomic-vc142-mt-gd-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_context-vc142-mt-gd-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_fiber-vc142-mt-gd-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_date_time-vc142-mt-gd-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_regex-vc142-mt-gd-x32-1_75.lib)
		else()
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_atomic-vc142-mt-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_context-vc142-mt-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_fiber-vc142-mt-s-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_date_time-vc142-mt-s-x32-1_75.lib)
			target_link_libraries(Boost INTERFACE ${WOLF_EXTERN_DEPS_DIR}/boost/lib/${PREFIX_LIB_PATH}/${CMAKE_BUILD_TYPE}/libboost_regex-vc142-mt-s-x32-1_75.lib)
		endif()
    elseif(LINUX)
        if (CMAKE_BUILD_TYPE MATCHES Debug)
