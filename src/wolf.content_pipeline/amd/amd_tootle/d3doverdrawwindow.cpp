    ...
    for (int i = -1; i < 2; i += 2)
        for (int j = -1; j < 2; j += 2)
            for (int k = -1; k < 2; k += 2)
            {
                ...
                xminA = std::min(xminA, x);
                yminA = std::min(yminA, y);
                xmaxA = std::max(xmaxA, x);
                ymaxA = std::max(ymaxA, y);
                ...
                xminB = std::min(xminB, x);
                yminB = std::min(yminB, y);
                xmaxB = std::max(xmaxB, x);
                ymaxB = std::max(ymaxB, y);
