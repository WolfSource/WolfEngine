...
extern "C" {
    ...
    #[doc = " Object can be released using LZ4F_freeCompressionContext();"]
    #[doc = " Note: LZ4F_freeCompressionContext() works with NULL pointers (do nothing)."]
...
extern "C" {
    ...
    #[doc = "  After an error, the state is left in a UB state, and must be re-initialized or freed."]
