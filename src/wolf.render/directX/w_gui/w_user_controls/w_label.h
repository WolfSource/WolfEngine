...
namespace wolf
{
	namespace gui
	{
		...
		public:
			...
			virtual void									render(_In_ const float pElapsedTime) override;
...
#pragma region Getter
			...
			WGUI_EXP w_color								get_label_color() const											{ return w_color::from_hex(this->label_color); }
			WGUI_EXP w_color								get_label_mouse_over_color() const								{ return w_color::from_hex(this->label_mouse_over_color); }
			WGUI_EXP w_color								get_label_pressed_color() const									{ return w_color::from_hex(this->label_pressed_color); }
			WGUI_EXP w_color								get_label_focused_color() const									{ return w_color::from_hex(this->label_focused_color); }
			WGUI_EXP w_color								get_label_disabled_color() const								{ return w_color::from_hex(this->label_disabled_color); }
...
#pragma region Setter
            ...
            WGUI_EXP HRESULT								set_text(_In_z_ const std::wstring& pText)                      { this->text = pText; }
