...
/*! \brief This class is responsible for manipulating the OCR tasks.
   ...
   optical character reading purposes. In the project, in other classes, in the
   case of reading an optical character, one must create an object of the OCR
   class.
*/
class OCR {
public:
  ...
  //! All configurations need for OCR.
  /*!
          The necessary configurations use for creating OCR class objects.
  */
  ...
  */
  auto char_vec_to_string(_In_ std::vector<OCR::characters_struct> char_vector,
                          _In_ cv::Mat &frame,
  ...
  */
  ...
  /*!
     ...
     image to reach a better OCR result.
  ...
  */
  ...
  cluster_char_structs(std::vector<OCR::characters_struct> characters,
