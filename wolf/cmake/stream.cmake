...
if (WOLF_STREAM_GRPC)
    ...
    if(WOLF_TEST)
        ...
        target_link_libraries(generate-protos PUBLIC protobuf::libprotobuf gRPC::grpc++) #gRPC::grpc++  gRPC::grpc++_unsecure
        ...
        asio_grpc_protobuf_generate(
            ...
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/hello.proto")

        asio_grpc_protobuf_generate(
            GENERATE_GRPC GENERATE_MOCK_CODE
            TARGET generate-protos
            USAGE_REQUIREMENT PUBLIC
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/validate/"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/validate/validate.proto")

        asio_grpc_protobuf_generate(
            GENERATE_GRPC GENERATE_MOCK_CODE
            TARGET generate-protos
            USAGE_REQUIREMENT PUBLIC
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/protoc-gen-openapiv2/options"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/protoc-gen-openapiv2/options/openapiv2.proto")
        ...
        asio_grpc_protobuf_generate(
            ...
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/protoc-gen-openapiv2/options"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/protoc-gen-openapiv2/options/annotations.proto")

        asio_grpc_protobuf_generate(
            GENERATE_GRPC GENERATE_MOCK_CODE
            TARGET generate-protos
            USAGE_REQUIREMENT PUBLIC
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/google/api"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/google/api/field_behavior.proto")
        ...
        asio_grpc_protobuf_generate(
            ...
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/google/api"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/google/api/http.proto")
        ...
        asio_grpc_protobuf_generate(
            ...
            IMPORT_DIRS ${PROTO_IMPORT_DIRS} "${CMAKE_CURRENT_SOURCE_DIR}/protos/google/api"
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/google/api/annotations.proto")
        ...
        asio_grpc_protobuf_generate(
            ...
            OUT_DIR "${PROTO_BINARY_DIR}"
            PROTOS "${CMAKE_CURRENT_SOURCE_DIR}/protos/api/v1/game.proto")

        list(APPEND INCLUDES "${PROTO_BINARY_DIR}")
        list(APPEND TESTS_SRCS 

            "${PROTO_BINARY_DIR}/hello.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/hello.pb.cc"

            "${PROTO_BINARY_DIR}/validate/validate.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/validate/validate.pb.cc"

            "${PROTO_BINARY_DIR}/protoc-gen-openapiv2/options/openapiv2.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/protoc-gen-openapiv2/options/openapiv2.pb.cc"

            "${PROTO_BINARY_DIR}/protoc-gen-openapiv2/options/annotations.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/protoc-gen-openapiv2/options/annotations.pb.cc"

            "${PROTO_BINARY_DIR}/google/api/field_behavior.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/google/api/field_behavior.pb.cc"

            "${PROTO_BINARY_DIR}/google/api/http.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/google/api/http.pb.cc"

            "${PROTO_BINARY_DIR}/google/api/annotations.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/google/api/annotations.pb.cc"

            "${PROTO_BINARY_DIR}/api/v1/game.grpc.pb.cc"
            "${PROTO_BINARY_DIR}/api/v1/game.pb.cc"
         )
    endif()
