...
w_openal::w_openal(_In_ const w_openal_config &p_config) noexcept
    : _config(p_config), _device(nullptr), _ctx(nullptr), _data(nullptr),
      _data_size(0), _read_pos(0), _write_pos(0), _buffer(0), _source(0),
      _start_offset(0), _decoder_offset(0), _total_read_bytes(0),
      _size_of_chunk(0), _callback_ptr(nullptr) {}
