...
pub const LUAJIT_VERSION: &[u8; 19usize] = b"LuaJIT 2.1.0-beta2\0";
pub const LUAJIT_VERSION_NUM: u32 = 20100;
pub const LUAJIT_COPYRIGHT: &[u8; 34usize] = b"Copyright (C) 2005-2017 Mike Pall\0";
pub const LUAJIT_URL: &[u8; 19usize] = b"http://luajit.org/\0";
...
pub const LUAJIT_MODE_ENGINE: ::std::os::raw::c_uint = 0;
pub const LUAJIT_MODE_DEBUG: ::std::os::raw::c_uint = 1;
pub const LUAJIT_MODE_FUNC: ::std::os::raw::c_uint = 2;
pub const LUAJIT_MODE_ALLFUNC: ::std::os::raw::c_uint = 3;
pub const LUAJIT_MODE_ALLSUBFUNC: ::std::os::raw::c_uint = 4;
pub const LUAJIT_MODE_TRACE: ::std::os::raw::c_uint = 5;
pub const LUAJIT_MODE_WRAPCFUNC: ::std::os::raw::c_uint = 16;
pub const LUAJIT_MODE_MAX: ::std::os::raw::c_uint = 17;
