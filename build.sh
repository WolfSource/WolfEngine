...
xcodebuild clean build -workspace ../../engine/builds/xcode/wolf.engine.vulkan.metal.macOS.xcworkspace -scheme wolf_vulkan_metal_macOS -sdk macosx10.12 -configuration Debug
