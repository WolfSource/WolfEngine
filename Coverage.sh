...
grcov . -s . --ignore ./wolf/build.rs --ignore ./wolf/sys/* --ignore ./wolf/src/system/ffi/* --ignore ./wolf/src/stream/ffi/* --ignore ./wolf/src/media/ffi/* --binary-path ./target/debug/ -t html --branch --ignore-not-existing -o ./coverage/