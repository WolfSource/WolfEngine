...
Convey("concurrency", {
 ...
 Convey("io", {
    ...
    w_file_info _io_file_get_info_from_path = w_io_file_get_info_from_path(pathcreate);
    ...
    const char* _io_file_get_base_name_from_path = w_io_file_get_base_name_from_path(pathcreate);
    const char* _base_name_from_path = "E:\\file";
    int result_extention2 = strcmp(_io_file_get_base_name_from_path, _base_name_from_path);
    So(result_extention2 == 0);
    ...
    const char* _io_file_get_name = w_io_file_get_name(_io_file_create);
    So(_io_file_get_name == NULL);
   ...
   const char* io_dir_get_parent = w_io_dir_get_parent(pathcreate);
   const char* _get_parent = "E:\\file.txt";
   int  result_get_parent = strcmp(io_dir_get_parent, _get_parent);
   So(result_get_parent == 0);


   W_RESULT	io_dir_create = w_io_dir_create(pathcreate);
   So(io_dir_create == 0);
