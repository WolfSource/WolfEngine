...
public:
	 ...
	 */
    W_EXP static MaskedOcclusionCulling *Create(pfnAlignedAlloc memAlloc, pfnAlignedFree memFree);
	...
	*/
    W_EXP virtual void GetResolution(unsigned int &width, unsigned int &height) = 0;
	...
	*/
    W_EXP virtual float GetNearClipPlane() = 0;
	 ...
	 */
    W_EXP virtual CullingResult RenderTriangles(const float *inVtx, const unsigned int *inTris, int nTris, const float *modelToClipMatrix = nullptr, ClipPlanes clipPlaneMask = CLIP_PLANE_ALL, const ScissorRect *scissor = nullptr, const VertexLayout &vtxLayout = VertexLayout(16, 4, 12)) = 0;
	 ...
	 */
    W_EXP virtual CullingResult TestTriangles(const float *inVtx, const unsigned int *inTris, int nTris, const float *modelToClipMatrix = nullptr, ClipPlanes clipPlaneMask = CLIP_PLANE_ALL, const ScissorRect *scissor = nullptr, const VertexLayout &vtxLayout = VertexLayout(16, 4, 12)) = 0;
	 ...
	 *        as compactly in memory as possible.
	 */
    W_EXP virtual void BinTriangles(const float *inVtx, const unsigned int *inTris, int nTris, TriList *triLists, unsigned int nBinsW, unsigned int nBinsH, const float *modelToClipMatrix = nullptr, ClipPlanes clipPlaneMask = CLIP_PLANE_ALL, const VertexLayout &vtxLayout = VertexLayout(16, 4, 12)) = 0;
	 ...
	 */
    W_EXP virtual void ComputePixelDepthBuffer(float *depthData) = 0;
