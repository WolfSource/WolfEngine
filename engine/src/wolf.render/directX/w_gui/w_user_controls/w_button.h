...
#pragma region Getters				  
			...
			DX_EXP bool					get_icon_is_absolute_path() const					{ return this->icon_is_absolute_path; }
			...
			DX_EXP UINT					get_use_default_icon_size() const					{ return this->use_default_icon_size; }
...
#pragma region Setters				  
			...
			DX_EXP void					set_icon_path(_In_z_ const std::wstring& pValue,
				_In_ const bool pIsAbsolutePath)											{ this->icon_path = pValue; this->icon_is_absolute_path = pIsAbsolutePath; }
			DX_EXP void					set_icon_offset(int pX, int pY)						{ this->icon_offset_x = pX; this->icon_offset_y = pY; }
			DX_EXP void					set_icon_size(float pWidth, float pHeight)			{ this->icon_width = pWidth; this->icon_height = pHeight; }
			DX_EXP void					set_use_default_icon_size(_In_ bool pValue)			{ this->use_default_icon_size = pValue; }
