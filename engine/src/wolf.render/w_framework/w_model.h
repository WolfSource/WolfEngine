...
//
//                    //load mesh
//                    _mesh->set_vertex_binding_attributes(this->_instances_count ? this->_instance_declaration:
...
//            wolf::graphics::w_mesh::w_vertex_binding_attributes         _vertex_binding_declaration;
