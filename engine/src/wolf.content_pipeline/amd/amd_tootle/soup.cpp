...
ComputeNormals(bool force)
{
    ...
    logger.write("[AMD TOOTLE Debugger] Flag: DEBUG - Message : Done with normals");
...
ComputeTriNormals(std::vector<Vector3>& tn)
{
    ...
    logger.write("[AMD TOOTLE Debugger] Flag: DEBUG - Message : Done with tri normals");
...
ComputeTriCenters(std::vector<Vector3>& tc)
{
    ...
    logger.write("[AMD TOOTLE Debugger] Flag: DEBUG - Message : Done with tri centers");
    return 1;
}
