/*
	...
	Name			 : py_content_manager.h
	Description		 : The python exporter for w_content_manager class
	Comment          :
*/

#ifdef __PYTHON__

#ifndef __PY_CONTENT_MANAGER_H__
#define __PY_CONTENT_MANAGER_H__
...
#endif//__PY_CONTENT_MANAGER_H__
