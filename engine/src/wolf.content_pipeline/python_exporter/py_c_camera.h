/*
	...
	Name			 : py_c_camera.h
	Description		 : The python exporter for c_camera classe
	Comment          :
*/

#ifdef __PYTHON__

#ifndef __PY_C_CAMERA_H__
#define __PY_C_CAMERA_H__

namespace pyWolf
{
	static void py_c_camera_export()
	{
		using namespace boost::python;
		using namespace wolf::content_pipeline;

		//export w_cpipeline_scene struct
		class_<w_c_camera>("w_c_camera", init<>())
...
//            .def("get_model_by_id", &w_cpipeline_scene::py_get_model_by_id, "get model by id")
