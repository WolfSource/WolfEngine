...
#pragma region Getters				  
			...
			w_color					  get_button_normal_color() const					{ return w_color::from_hex(this->button_normal_color); }
			w_color					  get_button_pressed_color() const					{ return w_color::from_hex(this->button_pressed_color); }
			w_color					  get_button_mouse_over_color() const				{ return w_color::from_hex(this->button_mouse_over_color); }
			w_color					  get_button_focused_color() const					{ return w_color::from_hex(this->button_focused_color); }
			w_color					  get_button_disabled_color() const					{ return w_color::from_hex(this->button_disabled_color); }
...
#pragma region Setters				  
			...
			void					  set_button_color(w_color pValue)					{ this->button_normal_color = RGBA_TO_HEX_COLOR(pValue.r, pValue.g, pValue.b, pValue.a); }
			void					  set_button_pressed_color(w_color pValue)			{ this->button_pressed_color = RGBA_TO_HEX_COLOR(pValue.r, pValue.g, pValue.b, pValue.a); }
			void					  set_button_mouse_over_color(w_color pValue)		{ this->button_mouse_over_color = RGBA_TO_HEX_COLOR(pValue.r, pValue.g, pValue.b, pValue.a); }
			void					  set_button_focused_color(w_color pValue)			{ this->button_focused_color = RGBA_TO_HEX_COLOR(pValue.r, pValue.g, pValue.b, pValue.a); }
			void					  set_button_disabled_color(w_color pValue)			{ this->button_disabled_color = RGBA_TO_HEX_COLOR(pValue.r, pValue.g, pValue.b, pValue.a); }
