...
#ifndef __W_LISTBOX_H__
#define __W_LISTBOX_H__
...
namespace wolf
{
	namespace gui
	{
		...
		{
		public:
			DX_EXP w_listBox(_In_opt_ w_widget* pParent = nullptr);
			DX_EXP virtual ~w_listBox();
...
#pragma region Getters
			...
			DX_EXP w_listBoxItem*		get_item(_In_ int pIndex) const;
			...
			*/
			...
			DX_EXP w_listBoxItem*		get_selected_item(_In_ int pPreviousSelected = -1) const		{ return get_item(get_selected_index(pPreviousSelected)); }

			DX_EXP W_COLOR				get_listBox_color() const										{ return DirectX::DWORD_COLOR_TO_W_COLOR(this->_listBox_color); }																					 
			DX_EXP W_COLOR				get_listBox_selected_color() const								{ return DirectX::XMFLOAT4_TO_W_COLOR(this->_listBox_selected_color); }
			DX_EXP W_COLOR				get_listBox_disabled_color() const								{ return DirectX::DWORD_COLOR_TO_W_COLOR(this->_listBox_disabled_color); }
...
#pragma region Setters
			...
			DX_EXP void				set_listBox_color(W_COLOR pColor)								{ this->_listBox_color = RGBA_TO_DWORD_COLOR(pColor.r, pColor.g, pColor.b, pColor.a); }
			DX_EXP void				set_listBox_selected_color(W_COLOR pColor)						{ this->_listBox_selected_color = DirectX::W_COLOR_TO_XMFLOAT4(pColor); }
			DX_EXP void				set_listBox_disabled_color(W_COLOR pColor)						{ this->_listBox_disabled_color = RGBA_TO_DWORD_COLOR(pColor.r, pColor.g, pColor.b, pColor.a); }
...
#pragma endregion
		...
		protected:
			...
			std::vector<w_listBoxItem*> items;
