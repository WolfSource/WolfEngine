...
namespace wolf
{
	...
	{		
		...
		public:
			...
			DX_EXP HRESULT render(_In_ const float pElapsedTime);
			...
			*/
			DX_EXP HRESULT add_image(_In_ int pID,
				...
				_In_ float pScaleX = 1.0f, _In_ float pScaleY = 1.0f,
