...
#pragma region Getters
			...
			DX_EXP	void				get_position(int& pX, int& pY) const		{ pX = this->x; pY = this->y; }
			DX_EXP	W_GUI_CONTROL_TYPE	get_type() const							{ return this->type; }
			DX_EXP	int					get_ID() const								{ return this->id; }
			DX_EXP	//get hot key
...
#pragma region Setters
			...
			DX_EXP void					set_position(_In_ int pX, _In_ int pY)		{ this->x = pX; this->y = pY; update_rects(); }
