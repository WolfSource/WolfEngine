...
#ifndef __W_SCROLLBAR_H__
#define __W_SCROLLBAR_H__
...
namespace wolf
{
	namespace gui
	{
		class w_scrollBar : public w_control
		{
		public:
			w_scrollBar(_In_opt_ w_widget* pParent = nullptr);
			virtual ~w_scrollBar();
...
#pragma region Getters
			...
			W_COLOR		get_scroll_color() const							{ return DirectX::DWORD_COLOR_TO_W_COLOR(this->_scroll_color); }
			W_COLOR		get_scroll_background_color() const					{ return DirectX::DWORD_COLOR_TO_W_COLOR(this->_scroll_background_color); }
			W_COLOR		get_scroll_disabled_color() const					{ return DirectX::DWORD_COLOR_TO_W_COLOR(this->_scroll_disabled_color); }
...
#pragma region Setters
			...
			void		set_scroll_color(W_COLOR pColor)					{ this->_scroll_color = RGBA_TO_DWORD_COLOR(pColor.r, pColor.g, pColor.b, pColor.a); }
			void		set_scroll_background_color(W_COLOR pColor)			{ this->_scroll_background_color = RGBA_TO_DWORD_COLOR(pColor.r, pColor.g, pColor.b, pColor.a); }
			void		set_scroll_disabled_color(W_COLOR pColor)			{ this->_scroll_disabled_color = RGBA_TO_DWORD_COLOR(pColor.r, pColor.g, pColor.b, pColor.a); }
