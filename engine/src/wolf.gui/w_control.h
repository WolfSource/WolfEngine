...
namespace wolf
{
	namespace gui
	{
		...
		public:
			...
			virtual void				    render_2d( _In_ const float& pElapsedTime, _In_ std::vector<w_gui_vertex_2d>& pVertexDeclarations);
            //virtual void				    render_3d(_In_ const float& pElapsedTime);
            ...
            */
            static void                    generate_2d_vertices(
                ...
                _Inout_ std::vector<w_gui_vertex_2d>& pVertexDeclarations);
