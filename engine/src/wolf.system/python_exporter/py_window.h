...
namespace pywolf
{
    static void py_window_export()
    {
        ...
        class_<w_window_info>("w_window_info", init<>())
            ...
            .def_readwrite("v_sync", &w_window_info::v_sync, "Enable/Disable GPU V-Sync")
			...
			.def_readwrite("double_buffering", &w_window_info::double_buffering, "Enable double buffering")
