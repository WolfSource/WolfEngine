...
#ifndef __W_QUATERNION_H__
#define __W_QUATERNION_H__
...
namespace wolf
{
	namespace system
	{
		...
		{
		public:
            WSYS_EXP w_quaternion();
            WSYS_EXP w_quaternion(_In_ const float& pX, _In_ const float& pY, _In_ const float& pZ, _In_ const float& pW);
            //WSYS_EXP w_quaternion(_In_ const w_vector3& pVectorPart, _In_ const float& pScalarPart);
            WSYS_EXP virtual ~w_quaternion();


            WSYS_EXP static w_quaternion identity() { return _identity; }
