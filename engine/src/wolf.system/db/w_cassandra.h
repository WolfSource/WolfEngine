...
#define CASS_LOG_MAX_MESSAGE_SIZE 1024
         ...
         * @return Client id.
         */
        W_SYSTEM_EXPORT w_CassUuid
            w_cassandra_session_get_client_id(w_Cass_Session* session);
         ...
         */
        W_SYSTEM_EXPORT w_CassVersion
            w_cassandra_schema_meta_version(const w_Cass_Schema_Meta* schema_meta);
