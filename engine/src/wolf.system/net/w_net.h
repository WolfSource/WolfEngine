...
#include <concurrency/w_thread.h>
    ...
    typedef enum w_socket_protocol
    {
        ...
        W_SOCKET_PROTOCOL_TCP_LISTENER = W_SOCKET_PROTOCOL_TCP_DIALER,
        W_SOCKET_PROTOCOL_UDP_DIALER = 17,
        W_SOCKET_PROTOCOL_UDP_LISTENER = W_SOCKET_PROTOCOL_UDP_DIALER,
        W_SOCKET_PROTOCOL_SCTP_DIALER = 132,
        W_SOCKET_PROTOCOL_SCTP_LISTENER = W_SOCKET_PROTOCOL_SCTP_DIALER,
    } w_socket_protocol;
