...
#define WOLF_MINOR_VERSION 60// Adding functionality in a backwards - compatible manner.
#define WOLF_PATCH_VERSION 19// bug fixes
#define WOLF_DEBUG_VERSION 4// for debugging.
