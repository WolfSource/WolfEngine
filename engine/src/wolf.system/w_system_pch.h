...
#define WOLF_MINOR_VERSION 39// when you add functionality in a backwards - compatible manner.
#define WOLF_PATCH_VERSION 3// bug fixes
#define WOLF_DEBUG_VERSION 22// for debugging.
