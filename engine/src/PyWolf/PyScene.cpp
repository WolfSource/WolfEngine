...
PyScene::PyScene(
    _In_z_ const std::wstring& pRunningDirectory,
...
void PyScene::initialize(_In_ std::map<int, std::vector<w_window_info>> pOutputWindowsInfo)
{
...
HRESULT PyScene::build_draw_command_buffers(_In_ const std::shared_ptr<w_graphics_device>& pGDevice)
{
...
void PyScene::update(_In_ const wolf::system::w_game_time& pGameTime)
{
...
HRESULT PyScene::render(_In_ const wolf::system::w_game_time& pGameTime)
{
...
void PyScene::on_window_resized(_In_ UINT pIndex)
{
    w_game::on_window_resized(pIndex);
}

void PyScene::on_device_lost()
{
    w_game::on_device_lost();
}

ULONG PyScene::release()
{
