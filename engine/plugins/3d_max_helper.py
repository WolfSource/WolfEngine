...
#PyWolfPath = "E:\\SourceCode\\github\\WolfSource\\Wolf.Engine\\engine\\plugins\\Wolf.Engine.Plugins (v.1.44.7.14)\\Wolf\\dlls\\"

#if PyWolfPath != "" and (not PyWolfPath in sys.path):
	#sys.path.append(PyWolfPath)
	
wolf_version = "PyWolf (v.1.46.1.0) without Wolf"
...
def init_reinstance_layout():
	...
	button_3 = QPushButton("ReInstance All Layers")
	button_3.clicked.connect(reinstance_all_layers)
	button_3.setToolTip("I'm responisble to re-instnace all nodes of all layers")
