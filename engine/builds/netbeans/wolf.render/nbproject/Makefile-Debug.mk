...
${OBJECTDIR}/_ext/24207458/dllmain.o: ../../../src/wolf.render/dllmain.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../src/wolf.system -I../../../../../../VulkanSDK/1.0.42.0/x86_64/include -I../../../src/wolf.render/ -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/24207458/dllmain.o ../../../src/wolf.render/dllmain.cpp

${OBJECTDIR}/_ext/24207458/w_game.o: ../../../src/wolf.render/w_game.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/24207458
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../src/wolf.system -I../../../../../../VulkanSDK/1.0.42.0/x86_64/include -I../../../src/wolf.render/ -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/24207458/w_game.o ../../../src/wolf.render/w_game.cpp

${OBJECTDIR}/_ext/24207458/w_graphics_device_manager.o: ../../../src/wolf.render/w_graphics_device_manager.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/24207458
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../src/wolf.system -I../../../../../../VulkanSDK/1.0.42.0/x86_64/include -I../../../src/wolf.render/ -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/24207458/w_graphics_device_manager.o ../../../src/wolf.render/w_graphics_device_manager.cpp

${OBJECTDIR}/_ext/24207458/w_render_pch.o: ../../../src/wolf.render/w_render_pch.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/24207458
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../src/wolf.system -I../../../../../../VulkanSDK/1.0.42.0/x86_64/include -I../../../src/wolf.render/ -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/24207458/w_render_pch.o ../../../src/wolf.render/w_render_pch.cpp
