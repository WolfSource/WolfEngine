...
MainPage::MainPage() : windowVisible(true), coreInput(nullptr)
{
	InitializeComponent();
	...
	this->mainGame = make_unique<MainGame>();
	this->mainGame->Initialize(window, this->swapChainPanel);
}
...
void MainPage::OnExitBtn(Platform::Object^, Windows::UI::Xaml::RoutedEventArgs^)
{
	Release();
	Application::Current->Exit();
}

ULONG MainPage::Release()
{
