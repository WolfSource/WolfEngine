...
Wolf Engine is written in C++ and supports Python and Lua as an embedded script languages.</p>
...
<ul>
<li>Your access to and use of Wolf Engine on GitHub is governed by the&nbsp;<a href="https://github.com/PooyaEimandar/Wolf.Engine/blob/master/LICENSE">MIT License Agreement</a>. If you don't agree to those terms, then you are not permitted to access or use Wolf Engine.
</li>
<li>term <a href="https://moltengl.com/moltenvk/" target="_blank">MoltenVK</a> MoltenVK is an implementation of Vulkan that runs on Apple's Metal graphics framework</li>
<li>term <a href="http://en.fanap.ir/" target="_blank">Fanap</a> is trademark of registered company</li>
<li>term <a href="http://en.alalam.ir/" target="_blank">AlAlam</a> is trademark of registered news network TV channel</li>
</ul>
<!--Issues-->
