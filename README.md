...
Wolf engine used on <strong>Microsoft WinRT</strong> platforms (Windows​ 8, 8.1, 10, Windows Phone 8, 8.1 and later versions ) and also supports Android based on openGL ES and NDK and it is adapted for a range of video game genres. 
