...
Wolf Engine is written in C++ and supports Python as an embedded script language.
The Wolf uses DirectX for rendering on <b>Windows Win32 and Universal Windows Platform</b>, however I’m working on <b>Vulkan render engine for Android/Ubuntu</b>, <b>Apple Metal render engine for OSX/IOS</b> and <ab>webGL for the HTML5 platform</b></p>
