...
#include "W_GraphicsResource\W_Direct2D\W_Line.h"
...
private:
	...
	std::unique_ptr<Wolf::Graphics::Direct2D::Shapes::W_Rectangle> rectangle2D;
	std::unique_ptr<Wolf::Graphics::Direct2D::Shapes::W_Rectangle> roundedRectangle2D;
	std::unique_ptr<Wolf::Graphics::Direct2D::Shapes::W_Ellipse> ellipse;
	std::unique_ptr<Wolf::Graphics::Direct2D::Shapes::W_Line> line;
	float width;
	float height;
};
