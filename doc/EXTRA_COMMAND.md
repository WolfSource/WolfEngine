...
$ cargo build --package wolf-system --release --target aarch64-unknown-linux-musl
```
...
```shell
$ brew install upx
$ upx --ultra-brute ./target/aarch64-unknown-linux-musl/release/wolf-system
```

```shell
$ perf record --call-graph dwarf ./target/aarch64-unknown-linux-musl/release/wolf-system
