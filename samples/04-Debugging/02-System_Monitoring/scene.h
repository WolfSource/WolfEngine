/*
	...
	Comment          : This sample shows how to monitor and print system information on the screen
*/
...
#include <W_Game.h>
#include <W_Framework\W_Monitor.h>
...
private:
	...
	std::unique_ptr<Wolf::Framework::W_Monitor> monitor;
