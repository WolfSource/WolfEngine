...
private:
	...
	//basic shapes
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_rectangle>						_rectangle_2D;
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_rectangle>						_rounded_rectangle_2D;
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_ellipse>						_ellipse;
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_line>							_line;
	float _width;
	float _height;
};
