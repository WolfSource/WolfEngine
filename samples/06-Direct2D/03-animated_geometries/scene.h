...
private:
	...
	//basic shapes
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_ellipse>		_sun;
	std::vector<wolf::graphics::direct2D::shapes::w_geometry*>			_photons;
	
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_geometry>		_cloud;

	std::unique_ptr<wolf::graphics::direct2D::shapes::w_rectangle>		_sea;

	std::vector<wolf::graphics::direct2D::shapes::w_geometry*>			_waves;
};
