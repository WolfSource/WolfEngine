...
WOLF_MAIN()
{
    ...
    _log_config.app_name = L"12_networking_two_way_server";
    ...
    {
        logger.write("two way server launched with socket ID: {}", pSocketID);
    ...
    w_network _puller;
    _puller.setup_two_way_server("tcp://127.0.0.1:1235", on_bind_established, 100, 100);
