...
private:
	...
	wolf::gui::w_widget*																_widget_1;
	wolf::gui::w_widget*																_widget_2;
	wolf::gui::w_widget*																_widget_3;

	void on_widget_mouse_move_callback(const POINT& pMousePoint);
	void on_widget_mouse_enter_callback(const POINT& pMousePoint);
	void on_widget_mouse_leave_callback(const POINT& pMousePoint);
};
