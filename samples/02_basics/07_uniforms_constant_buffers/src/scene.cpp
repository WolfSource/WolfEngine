...
#ifdef WIN32
	auto _content_path_dir = wolf::system::io::get_current_directoryW() + L"/../../../../samples/02_basics/07_uniforms_constant_buffers/src/content/";
...
void scene::update(_In_ const wolf::system::w_game_time& pGameTime)
{
	...
	//update uniform's data
	auto _scale = cos(pGameTime.get_total_seconds());
	this->_u0.data.wvp = glm::mat4(1) * glm::scale(glm::vec3(_scale));
