...
void scene::load()
{
	...
	//++++++++++++++++++++++++++++++++++++++++++++++++++++
#ifdef WIN32
	auto _content_path_dir = wolf::system::io::get_current_directoryW() + L"/../../../../samples/02_basics/03_vertex_buffer/src/content/";
	...
	_hr = this->_pipeline.load(_gDevice,
		...
		w_primitive_topology::TRIANGLE_STRIP,
