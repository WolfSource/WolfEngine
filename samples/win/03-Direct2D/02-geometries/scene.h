...
private:
	...
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_rectangle>		_rectangle;

	std::unique_ptr<wolf::graphics::direct2D::shapes::w_geometry>		_geo_cloud_0;
	std::unique_ptr<wolf::graphics::direct2D::shapes::w_geometry>		_geo_cloud_1;
