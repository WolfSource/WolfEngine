/*
	...
	Name			 : main.cpp
	Description		 : This sample shows how to create a widget user interface in Wolf Engine
...
int WINAPI WinMain(HINSTANCE pHInstance, HINSTANCE pPrevHInstance, PSTR pSTR, int pCmdshow)
{
	...
	*/
	...
	sWindowsInfo[0] = { { sWindow->get_HWND(), sWindow->get_width(), sWindow->get_height() } };
